      ...
      <div className={styles.tyPadding}>
        <div ref={setWrapperRef} className={styles.reportTy}>
          <div className={styles.tyInnerPadding}>
            ...
            <div className={styles.thankyouText}>These reports help make Airbnb better for everyone, so we take them seriously. We'll reach out if we have any questions about your report.</div>
          </div>
        </div>
      </div>
    </div>
